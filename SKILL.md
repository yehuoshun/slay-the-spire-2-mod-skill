...
> 自包含完整指南——从零搭建到全内容类型开发，无需查阅外部资料。
> 知识整合自 STS2Plus、ModTemplate-StS2、BaseLib-StS2、Sts2-YuWanCard、Megadot 及 B站开发教程 01-09，鸣谢详见 README。
...
4. **下载 BaseLib** — [GitHub Releases](https://github.com/Alchyr/BaseLib-StS2/releases/)，把 `.dll`、`.pck`、`.json` 放到 `Slay the Spire 2/mods/`
5. **安装模组模板**（Rider 中按 Alt+F12 打开终端）：
   ```bash
...
- **[BaseLib](https://github.com/Alchyr/BaseLib-StS2)** (NuGet) — 官方 STS2 Mod 框架，提供 `CustomCardModel`、`CustomCardPoolModel`、图像路径工具等
