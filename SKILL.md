...
> 📚 **深度参考：**
> - [references/architecture.md](references/architecture.md) — STS2-Plus / STS2-Mods / YuWanCard / BaseLib / ModTemplate 五大参考架构
> - [references/appendices.md](references/appendices.md) — 附录 B~G：资源路径、本地化、清单、csproj、生命周期钩子、常见坑
